...
function Itachi() {
  return (
    <>
      <div className="bg-white min-h-[600px] max-w-[1440px] mx-auto  grid md:grid-cols-2 items-center justify-center xs:px-0 md:px-16 md:gap-5">
        ...
        <div className="flex flex-col">
          <Lottie
            loop
            animationData={Colleges}
            play
            className="mx-auto my-10 md:w-600px lg:scale-125 md:h-auto sm:w-80 sm:h-48 "
          />
        </div>
      </div>
    </>
